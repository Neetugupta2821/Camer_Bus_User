...
export default function SearchBus() {
  ...
  console.log(getAll)
  console.log(location.state.fullData.AC_tripCount)
              ...
              <div>
                ...
                <div class="pt-3">
                  ...
                  <div>
                    ...
                    <label for="bustype" class="font-s py-2 px-2">AC ({location.state.fullData.AC_tripCount})</label>
                  </div>
                  <div>
                    <input type="checkbox" name="" id="bustype1" onClick={handleChange} value='Non-AC' />
                    <label for="bustype1" class="font-s py-2 px-2">Non-AC ({location.state.fullData.NON_AC_tripCount})</label>
                  </div>
                  <div>
                    <input type="checkbox" name="" id="bustype2" value='luxury' onClick={handleChange} />
                    <label for="bustype2" class="font-s py-2 px-2">{t('luxury')} ({location.state.fullData.lux_tripCount})</label>
                  </div>
                </div>
              </div>
              <div class="pt-3 mb-5">
                ...
                <div className='d-flex justify-content-start align-items-baseline'>
                  <input type="checkbox" name="" id="arrival1" onClick={handleChange1} value='00:00 - 06:00' />
                  <label for="arrival1" class="font-s py-2 px-2">00:00 - 06:00</label>
                </div>
                <div className='d-flex justify-content-start align-items-baseline'>
                  <input type="checkbox" name="" id="arrival2" onClick={handleChange1} value='06:00 - 11:00' />
                  <label for="arrival2" class="font-s py-2 px-2">06:00 - 11:00 </label>
                </div>
                <div className='d-flex justify-content-start align-items-baseline'>
                  <input type="checkbox" name="" id="arrival2" onClick={handleChange1} value='12:00 - 18:00' />
                  <label for="arrival2" class="font-s py-2 px-2">12:00 - 18:00</label>
                </div>
                <div className='d-flex justify-content-start align-items-baseline'>
                  <input type="checkbox" name="" id="arrival2" onClick={handleChange1} value='18:00 - 23:00' />
                  <label for="arrival2" class="font-s py-2 px-2">18:00 - 23:00 </label>
                </div>
              </div>
            </div>
                                                ...
                                                <span className="amountTaxes">
                                                  <b>{t('Selected seat')}
                                                    ...
                                                    selectedSeatsMap[info.trip._id].map((info, index) => (
                                                      <small key={index}> <React.Fragment key={index}>
                                                        {index > 0 && ', '}
                                                        {info.seat}
                                            ...
                                            <div className="radioButton">
                                              ...
                                              <div className="form-check">
                                                ...
                                                <label className="form-check-label" htmlFor="dropping1">
                                                  <span className="startTime">
                                                    <strong>{info.destinationExpectedTime}</strong>
                                                  </span>
                                                  <span>
                                                    <h5>{destination}</h5>
                                                    <p>
