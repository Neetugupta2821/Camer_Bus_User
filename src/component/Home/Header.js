                ...
                <div className="use_profile">
                  <div className="dropdown_prof">
                    <div className="profile">
                      ...
                      <div className="user text-start LightDarkNotification">
                        <h3>{name}</h3>
                        <p>{email}</p>
                      </div>
                    </div>
                        ...
                        <div className='notification_icon' onClick={HandleNotification}  >
                          ...
                          <li className="nav-item dropdown">
                            ...
                            >
                              ...
                              {/* <span className='badge' style={{ "backgroundColor": "red", "color": "white" }}>1</span>  */}
                              <div className="pulse-css" />
                            </a>
                            {/* */}
                            {open1 && (
                              <div className='menuProfile1' id="myDIV" ref={notificationRef}  >
                                {notification.length === 0 ? "sorry no notification" : (<div
