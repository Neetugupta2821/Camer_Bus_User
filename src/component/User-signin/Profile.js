...
export default function Profile() {
  ...
  const handelUserData = () => {
    axios.get(`${BaseUrl}getUser/${emailType}`).then((response) => {
      ...
      setSelectedImage(response.data.user_Details.profileImage?`${`http://192.168.1.54:4000/`}${response.data.user_Details.profileImage}`:"https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png")
  ...
  const handleSubmit = (e) => {
    ...
    axios.put(`${BaseUrl}updateUser/${update._id}`, formData, {
      headers: {
                ...
                <div className="content">
                  ...
                  <div className="text-content">
                        ...
                        <div className="userDetails">
                            ...
                            <div className="avatar-upload">
                              ...
                              <div className="avatar-preview">
                                <label htmlFor="image">
                                  ...
                                  width="150px"
                                  src={update.profileImage && selectedImage=== null ?"https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png":`${ImageBaseUrl}${update.profileImage}`}
                                />
                          ...
                          <div className="row userdet1">
                            <div className="col-md-6 userdetLeft form-group">
                              <div className="usertext">{t("Your Name")}*</div>
                              <input
                            ...
                            <div className="col-md-6 userdetRight form-group">
                              <div className="usertext">{t("Email")}*</div>
                              <input
                                id=""
                                className="disappear form-control"
                                type="email"
                            ...
                            <div className="col-md-6 userdetRight form-group">
                              <div className="usertext">{t('Phone Number')}*</div>
                              <input
                                id=""
                                className="disappear form-control"
                            ...
                            <div className="col-md-6 userdetRight">
                              <div className="usertext">{t("Age")}*</div>
                              <input
                                id=""
                            ...
                            <div className="col-md-6 gender mt-3">
                              <div className="usertext">{t("Gender")}*</div>
                              <span>
                                <input
                                  type="radio"
                                  id="male"
                    ...
                    <div className="blog text">
                      ...
                      <span style={{ "color": "red" }}>{message ? t("Please fill in all required fields.*") : null}</span>
                      <form>
                        ...
                        <div className="col-md-6 form-group mb-4">
                          ...
                          />
                          {error.isarray ? <div className="text-danger">{t(error.error.response.data.IncorrectPassword)}</div> : ""}
                        ...
                        <div className="col-md-6 form-group mb-4">
                          ...
                          />
                          {error.isarray ? <div className="text-danger">{t(error.error.response.data.notMatchedPassword)}</div> : ""}
