                      ...
                      <div className="col-xl-12">
                        <div className="auth-form">
                          ...
                          <form onSubmit={handleSubmit}>
                            ...
                            {errors.email ? <div className="text-danger">{errors.email}</div> : <div className="text-danger">{t(error?.error?.response?.data?.EmailMessage) ? t(error?.error?.response?.data?.EmailMessage) : errors?.email}</div>}
                            ...
                            <div className="text-center">
                              <Button variant="contained" type='submit' className="btn btnTextColor btn-block mt-3">{t("Sign In")}</Button>
                              {/* <button
                          type="submit"
